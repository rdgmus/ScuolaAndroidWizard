...
public class NomiClasseArrayAdapter extends ArrayAdapter<String> {
	private final Context _context;
	private final JSONArray _objects;

	public NomiClasseArrayAdapter(Context context, JSONArray objects,
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		try {
			...
			tvMyText.setText(s.getString("nome_classe"));
